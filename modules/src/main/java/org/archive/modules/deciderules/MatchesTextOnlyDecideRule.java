 ...
 * only do not accept anything but text
 * use: REJECT ALL
 */
public class MatchesTextOnlyDecideRule extends MatchesRegexDecideRule {

    public static enum Preset { 
        
        ALL(".*(?i)(\\.(bmp|gif|jpe?g|png|svg|tiff?|aac|aiff?|m3u|m4a|midi?" +
                "|mp2|mp3|mp4|mpa|ogg|ra|ram|wav|wma|asf|asx|avi|flv|mov|mp4" + 
                "|mpeg|mpg|qt|ram|rm|smil|wmv|swf|ico|css|gz|pls|3gp|cgi|xml"+
                "|m4v|wvx|ics|csv|exe|asp|zip|rar))($|[^a-zA-Z\\s].*)"),
     ...
     * Usual constructor.
     */
    public MatchesTextOnlyDecideRule() {
    }
